...
class _HomeMoviePageState extends State<HomeMoviePage> {
  ...
  void initState() {
    super.initState();
    context..read<MovieNowPlayingBloc>().add(OnMovieNowPlayingRequested())
      ..read<MoviePopularBloc>().add(OnPopularRequested())
      ..read<MovieTopRatedBloc>().add(OnTopRatedRequested());
  }
